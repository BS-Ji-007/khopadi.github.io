    ...
    <div className="min-h-screen pt-20 pb-10">
      ...
      <div className="relative h-96 bg-gradient-to-r from-red-900 via-gray-900 to-black">
        <div className="absolute inset-0 flex flex-col items-center justify-center p-4 text-center sm:p-6">
          ...
          <p className="mb-2 text-lg text-gray-300 sm:text-xl">Discover millions of movies, TV shows and anime</p>
          ...
          <form onSubmit={handleSearch} className="w-full max-w-2xl">
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 rounded-lg bg-white/10 px-4 py-3 text-white placeholder-gray-400 backdrop-blur-md focus:outline-none focus:ring-2 focus:ring-red-500 sm:px-6 sm:py-4"
              />
              <button
                type="submit"
                disabled={searching}
                className="rounded-lg bg-red-600 px-6 py-3 font-semibold text-white transition-colors hover:bg-red-700 disabled:opacity-50 sm:px-8 sm:py-4"
              >
                {searching ? '🔍' : '🔍'}
        ...
        <div className="mb-6 flex flex-col items-center justify-between sm:flex-row">
          ...
          {searchResults.length > 0 && (
            <button
              ...
              className="mt-2 text-red-500 hover:text-red-400 sm:mt-0"
            >
              ✖ Clear Search
            </button>
          )}
